 ...
 const buttonsMorning = document.querySelectorAll('#content-morning-market .road-element');
    ...
    const vendorData = {
      'morning-vendor1': {
        ...
        image: '../webimg/farmer/v1.svg',
        chat: [
          { sender: 'receiver', text: '婆婆~這些蔬菜看起來都好新鮮喔!' },
          { sender: 'sender', image: '../webimg/farmer/v1.svg' , text: '沒錯!這些都是早上現摘的，有機的沒有使用農藥呦' },
      ...
      'morning-vendor2': {
        ...
        friends: [
          { name: '小番茄攤販', image: '../webimg/farmer/ve1.png' },
